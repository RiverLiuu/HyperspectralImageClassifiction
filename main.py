...
parser.add_argument('--data_name',dest='data_name',default='WHU_Hi_LongKou')
parser.add_argument('--data_path',dest='data_path',default="/media/b104/0009C6090001341C/RiverLiu/data/WHU-Hi-LongKou")
...
parser.add_argument('--train_num',dest='train_num',default=0.2)
...
parser.add_argument('--epoch',dest='epoch',default=20001)#200001
